...
TD<-read.csv("DPTB_RT_9-19-14_TD_NoEG.csv")
d22q<-read.csv("DPTB_RT_9-19-14_22q_NoEG.csv")
...
write.csv(ax3, "noEGax3.csv")

###I removed some dupes

ax3<-read.csv("noEGax3.csv")
